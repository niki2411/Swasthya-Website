...
let brain;
let posesArray = ['1', 'Vriksasana1', 'Vriksasana2','Malasana'];
...
let correctPoses = ['1', 'Vriksasana1', 'Vriksasana2','Malasana'];

// Incorrect pose tracking
let incorrectPoses = ['Malasana'];
  ...
  if (results.length > 0 && results[0].confidence > confidenceThreshold) {
    ...
    switch (results[0].label) {
      case "1":
        ...
        break;
      case "2":
        poseLabel = "Vriksasana1";
        break;
      case "3":
        poseLabel = "Vriksasana2";
        break;
      default:
        poseLabel = "Malasana";
        break;
