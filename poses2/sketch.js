...
let brain;
let posesArray = ['Standing', 'VirabhadrasanaII', 'VirabhadrasanaII','VirabhadrasanaII Wrong','Sitting','Random Pose'];
...
let correctPoses = [ 'VirabhadrasanaII', 'VirabhadrasanaII'];

// Incorrect pose tracking
let incorrectPoses =['Standing','VirabhadrasanaII Wrong','Sitting','Random Pose'];
  ...
  if (results.length > 0 && results[0].confidence > confidenceThreshold) {
    ...
    switch (results[0].label) {
      case "1":
        ...
        break;
      case "2":
        poseLabel = "VirabhadrasanaII";
        break;
      case "3":
        poseLabel = "VirabhadrasanaII";
        break;;
      case "4":
        poseLabel = "VirabhadrasanaII Wrong";
        break;
      case "5":
        poseLabel = "Sitting";
        break;
