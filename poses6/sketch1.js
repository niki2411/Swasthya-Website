...
let brain;
let posesArray = ['Standing', 'Malasana', 'Malasana Wrong', 'Unknown Pose'];
let poseLabel = "No Pose Detected";
let poseStatus = "No Pose";
let confidenceThreshold = 0.75;

// Define correct and incorrect poses
let correctPoses = ['Malasana'];
let incorrectPoses = ['Standing', 'Malasana Wrong', 'Unknown Pose'];
...
function setup() {
  ...
  const modelInfo = {
    model: 'model/model (12).json',
    metadata: 'model/model_meta (12).json',
    weights: 'model/model.weights (12).bin',
  };
