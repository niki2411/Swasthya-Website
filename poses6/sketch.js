...
let correctPoses = ['1', 'Malasana'];;

// Incorrect pose tracking
let incorrectPoses = ['Unknown pose'];
...
function setup() {
  ...
  const modelInfo = {
    model: 'model/model (4).json',
    metadata: 'model/model_meta (4).json',
    weights: 'model/model.weights (4).bin',
  };
